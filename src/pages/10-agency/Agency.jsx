...
import imgLobby from './assets/1-Lobby.png'
import {ReactComponent as JamPap} from "./assets/1-James-Pappas.svg";
import {ReactComponent as HamSut} from "./assets/2-Hamish-Sutherland.svg";
import {ReactComponent as GeoMur} from "./assets/3-Georgina-Murray.svg";
import {ReactComponent as MicDar} from "./assets/4-Michael-Darvell.svg";
import {ReactComponent as ShaBur} from "./assets/5-Shane-Burns.svg";
...
function Agency(props) {
    ...
    const anim = useHomeAnim(props.main, ScrollConst.agencyHead, ScrollConst.homeBody);

    return (
        <section ref={props.pageRef.agency} className="agency">
